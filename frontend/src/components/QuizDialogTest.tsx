...
import { QuizDialog, QuizData } from "./QuizDialog"
    ...
    <div className="min-h-screen flex flex-col items-center justify-center gap-8 p-8 bg-background">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-md">
          Click the button below to open the quiz dialog. Test on different screen sizes
          using your browser's responsive design mode (F12 → Device toolbar).
        </p>
      </div>
      ...
      <div className="mt-8 p-6 border rounded-lg max-w-2xl space-y-4 bg-card">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <li>Click the device toolbar icon or press Cmd+Shift+M (Mac) / Ctrl+Shift+M (Windows)</li>
          <li>Select different devices:
            <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
              <li><strong>Mobile:</strong> iPhone SE (375px), iPhone 12 Pro (390px)</li>
              <li><strong>Tablet:</strong> iPad (768px), iPad Pro (1024px)</li>
              <li><strong>Desktop:</strong> Responsive 1200px+</li>
            </ul>
          </li>
          <li>Open the quiz dialog and verify:
            <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
